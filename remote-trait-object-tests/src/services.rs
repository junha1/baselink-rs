...
pub trait HelloFactory: remote_trait_object::Service {
    fn create(&self, name: &str) -> SArc<dyn HelloRobot>;
}

#[remote_trait_object_macro::service]
pub trait HelloRobot: remote_trait_object::Service {
...
#[remote_trait_object_macro::service]
pub trait Schedule: remote_trait_object::Service {
...
#[remote_trait_object_macro::service]
pub trait RelayerFactory: remote_trait_object::Service {
...
#[remote_trait_object_macro::service]
pub trait RelayerMachine: remote_trait_object::Service {
