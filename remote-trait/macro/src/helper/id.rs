...
pub fn generate_id_registeration(
    ...
    result.extend({
        ...
        let id_entry = quote! {
            ...
            static #id_ident: #env_path::TraitIdAtomic = #env_path::TraitIdAtomic::new(0);
            #[allow(non_upper_case_globals)]
            #[distributed_slice(#env_path::TID_REG)]
            static #id_entry_ident: (&'static str, fn(id: #env_path::TraitId)) =
            (#lit_trait_name, #id_setter_ident);
            #[allow(non_snake_case)]
            fn #id_setter_ident(id: #env_path::TraitId) {
    ...
    for (i, item) in the_trait.items.iter().enumerate() {
        ...
        let id_entry = quote! {
            ...
            #[distributed_slice(#env_path::MID_REG)]
            #[allow(non_upper_case_globals)]
