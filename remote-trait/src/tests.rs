...
mod env_mock {
    ...
    pub use super::remote_trait::env_mock::*;
}
...
#[remote_trait_macro::service_adv(env_mock)]
pub trait TestService: remote_trait::Service {
...
#[remote_trait_macro::service_impl_adv(env, TestService)]
pub struct TestImpl {
...
mod use_cast {
    ...
    fn service_2() {
        mock::set_key(2);
        remote_trait::port::server::port_thread_local::set_key(777);
